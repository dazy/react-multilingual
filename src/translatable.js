...
function translatable(mapStateToProps, mapDispatchToProps, mergeProps, options = {}) {
	...
	return function wrapWithTranslate(WrappedComponent) {
		const connectDisplayName = `Translated(${getDisplayName(WrappedComponent)})`;
		...
		class Translated extends Component {
			...
			configureFinalMapState(store, props) {
				...
				const mappedState = mapState(locale, props);
		...
		return hoistStatics(Translated, WrappedComponent);
	}
}
